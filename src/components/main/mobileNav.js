                ...
                <div className="d-flex">
                    <div className="px-5">
                        ...
                        <div className="py-3 d-flex justify-content-around">
                            ...
                            {/* <Link className="text-dark" to="/resume">Resume</Link> */}
                        </div>
                        <div className="py-sm-2 text-secondary text-center d-flex justify-content-around px-sm-3">
                            <a className="" target="_blank" rel="noopener noreferrer" href="instagram.com/lostshots"><i className="fa fa-instagram fa-2x px-1"></i></a>
                            <a className="" target="_blank" rel="noopener noreferrer" href="mailto:jonathangene@gmail.com"><i className="fa fa-envelope-o fa-2x px-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
