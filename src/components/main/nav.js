        ...
        <nav id="nav" className="col-md-2 px-3 py-2 fixed-top bg-white">
            ...
            <div className="p-3">
                <div className="">
                    ...
                    <div className="border-bottom border-primary pt-2"></div>
                ...
                <div className="py-sm-2 text-secondary text-center d-flex">
                    <a className="" target="_blank" rel="noopener noreferrer" href="//instagram.com/lostshots"><i className="fa fa-instagram fa-2x px-2"></i></a>
                    <a className="" target="_blank" rel="noopener noreferrer" href="mailto:jonathangene@gmail.com"><i className="fa fa-envelope-o fa-2x px-2"></i></a>
                </div>
            </div>
        </nav>
    )
